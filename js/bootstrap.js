...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(a) { "use strict"; var b = a.fn.jquery.split(" ")[0].split("."); if (b[0] < 2 && b[1] < 9 || 1 == b[0] && 9 == b[1] && b[2] < 1) throw new Error("Bootstrap's JavaScript requires jQuery version 1.9.1 or higher") }(jQuery), + function(a) {
    ...
    function b(b, d) {
        return this.each(function() {
            ...
            f || e.data("bs.mmodal", f = new c(this, g)), "string" == typeof b ? f[b](d) : g.show && f.show(d)
        })
    }
    var c = function(b, c) { this.options = c, this.$body = a(document.body), this.$element = a(b), this.$dialog = this.$element.find(".mmodal-dialog"), this.$backdrop = null, this.isShown = null, this.originalBodyPad = null, this.scrollbarWidth = 0, this.ignoreBackdropClick = !1, this.options.remote && this.$element.find(".mmodal-content").load(this.options.remote, a.proxy(function() { this.$element.trigger("loaded.bs.mmodal") }, this)) };
    c.VERSION = "3.3.5", c.TRANSITION_DURATION = 300, c.BACKDROP_TRANSITION_DURATION = 150, c.DEFAULTS = { backdrop: !0, keyboard: !0, show: !0 }, c.prototype.toggle = function(a) { return this.isShown ? this.hide() : this.show(a) }, c.prototype.show = function(b) {
        var d = this,
            e = a.Event("show.bs.mmodal", { relatedTarget: b });
        this.$element.trigger(e), this.isShown || e.isDefaultPrevented() || (this.isShown = !0, this.checkScrollbar(), this.setScrollbar(), this.$body.addClass("mmodal-open"), this.escape(), this.resize(), this.$element.on("click.dismiss.bs.mmodal", '[data-dismiss="mmodal"]', a.proxy(this.hide, this)), this.$dialog.on("mousedown.dismiss.bs.mmodal", function() { d.$element.one("mouseup.dismiss.bs.mmodal", function(b) { a(b.target).is(d.$element) && (d.ignoreBackdropClick = !0) }) }), this.backdrop(function() {
            var e = a.support.transition && d.$element.hasClass("fade");
            d.$element.parent().length || d.$element.appendTo(d.$body), d.$element.show().scrollTop(0), d.adjustDialog(), e && d.$element[0].offsetWidth, d.$element.addClass("in"), d.enforceFocus();
            var f = a.Event("shown.bs.mmodal", { relatedTarget: b });
    ...
    }, c.prototype.hide = function(b) { b && b.preventDefault(), b = a.Event("hide.bs.mmodal"), this.$element.trigger(b), this.isShown && !b.isDefaultPrevented() && (this.isShown = !1, this.escape(), this.resize(), a(document).off("focusin.bs.mmodal"), this.$element.removeClass("in").off("click.dismiss.bs.mmodal").off("mouseup.dismiss.bs.mmodal"), this.$dialog.off("mousedown.dismiss.bs.mmodal"), a.support.transition && this.$element.hasClass("fade") ? this.$element.one("bsTransitionEnd", a.proxy(this.hidemmodal, this)).emulateTransitionEnd(c.TRANSITION_DURATION) : this.hidemmodal()) }, c.prototype.enforceFocus = function() { a(document).off("focusin.bs.mmodal").on("focusin.bs.mmodal", a.proxy(function(a) { this.$element[0] === a.target || this.$element.has(a.target).length || this.$element.trigger("focus") }, this)) }, c.prototype.escape = function() { this.isShown && this.options.keyboard ? this.$element.on("keydown.dismiss.bs.mmodal", a.proxy(function(a) { 27 == a.which && this.hide() }, this)) : this.isShown || this.$element.off("keydown.dismiss.bs.mmodal") }, c.prototype.resize = function() { this.isShown ? a(window).on("resize.bs.mmodal", a.proxy(this.handleUpdate, this)) : a(window).off("resize.bs.mmodal") }, c.prototype.hidemmodal = function() {
        var a = this;
        this.$element.hide(), this.backdrop(function() { a.$body.removeClass("mmodal-open"), a.resetAdjustments(), a.resetScrollbar(), a.$element.trigger("hidden.bs.mmodal") })
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            if (this.$backdrop = a(document.createElement("div")).addClass("mmodal-backdrop " + e).appendTo(this.$body), this.$element.on("click.dismiss.bs.mmodal", a.proxy(function(a) { return this.ignoreBackdropClick ? void(this.ignoreBackdropClick = !1) : void(a.target === a.currentTarget && ("static" == this.options.backdrop ? this.$element[0].focus() : this.hide())) }, this)), f && this.$backdrop[0].offsetWidth, this.$backdrop.addClass("in"), !b) return;
        ...
        a.className = "mmodal-scrollbar-measure", this.$body.append(a);
        var b = a.offsetWidth - a.clientWidth;
        return this.$body[0].removeChild(a), b
    };
    var d = a.fn.mmodal;
    a.fn.mmodal = b, a.fn.mmodal.Constructor = c, a.fn.mmodal.noConflict = function() { return a.fn.mmodal = d, this }, a(document).on("click.bs.mmodal.data-api", '[data-toggle="mmodal"]', function(c) {
        var d = a(this),
            e = d.attr("href"),
            f = a(d.attr("data-target") || e && e.replace(/.*(?=#[^\s]+$)/, "")),
            g = f.data("bs.mmodal") ? "toggle" : a.extend({ remote: !/#/.test(e) && e }, f.data(), d.data());
        d.is("a") && c.preventDefault(), f.one("show.bs.mmodal", function(a) { a.isDefaultPrevented() || f.one("hidden.bs.mmodal", function() { d.is(":visible") && d.trigger("focus") }) }), b.call(f, g, this)
    })
}(jQuery), + function(a) {
    "use strict";
